        ...
        <section ref={containerRef} className="relative w-full h-[200vh]">
            <div className="sticky top-0 w-full h-screen overflow-hidden">
                ...
                <motion.div
                    ...
                    className="absolute inset-y-0 left-0 w-1/3 p-12 flex flex-col justify-center space-y-32 z-10 pointer-events-none"
                >
                    <div className="space-y-2">
                        <h3 className="text-white text-lg font-semibold tracking-wide">Comfort</h3>
                    ...
                    <div className="space-y-2">
                        <h3 className="text-white text-lg font-semibold tracking-wide">Material Quality</h3>
                        <p className="text-white/50 text-sm leading-relaxed max-w-[200px]">
                ...
                <motion.div
                    style={{ opacity: textOpacity }}
                    className="absolute inset-y-0 right-0 w-1/3 p-12 flex flex-col justify-center items-end text-right space-y-32 z-10 pointer-events-none"
                >
                    <div className="space-y-2">
                        <h3 className="text-white text-lg font-semibold tracking-wide">Pressure Distribution</h3>
                        <p className="text-white/50 text-sm leading-relaxed max-w-[200px]">
                            Increased contact area reduces pressure on the ear for a stable, comfortable fit.
                        </p>
                    </div>
                    <div className="space-y-2">
                        <h3 className="text-white text-lg font-semibold tracking-wide">Long-wear Ergonomics</h3>
                        <p className="text-white/50 text-sm leading-relaxed max-w-[200px]">
                ...
                <motion.div
                    style={{ opacity: textOpacity }}
                    className="absolute inset-y-0 left-0 w-1/2 bg-gradient-to-r from-black/80 to-transparent pointer-events-none"
                />
                <motion.div
                    style={{ opacity: textOpacity }}
                    className="absolute inset-y-0 right-0 w-1/2 bg-gradient-to-l from-black/80 to-transparent pointer-events-none"
                />
    ...
    return (
        <section ref={containerRef} className="relative w-full h-[200vh]">
            <div className="sticky top-0 w-full h-screen overflow-hidden">
                ...
                >
                    <div className="space-y-2">
                        <h3 className="text-white text-lg font-semibold tracking-wide">Rotation Limits</h3>
                        <p className="text-white/50 text-sm leading-relaxed max-w-[200px]">
                            Silent joints swivel inward, transforming the headphones into a compact case-ready form.
                        </p>
                    </div>
                    <div className="space-y-2">
                        <h3 className="text-white text-lg font-semibold tracking-wide">Fold Durability</h3>
                        <p className="text-white/50 text-sm leading-relaxed max-w-[200px]">
                ...
                >
                    <div className="space-y-2">
                        <h3 className="text-white text-lg font-semibold tracking-wide">Materials</h3>
                        <p className="text-white/50 text-sm leading-relaxed max-w-[200px]">
                            Aerospace-grade composite pivots with self-lubricating washers.
                        </p>
                    </div>
                    <div className="space-y-2">
                        <h3 className="text-white text-lg font-semibold tracking-wide">Longevity Testing</h3>
                        <p className="text-white/50 text-sm leading-relaxed max-w-[200px]">
